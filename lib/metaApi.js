...
export async function getMetaStatus() {
  return apiClient.get("/api/meta/status");
}
 ...
 */
export async function getMetaAssets() {
  return apiClient.get("/api/meta/assets");
}
 ...
 */
export async function getMetaOverview(params = {}) {
  return apiClient.get("/api/meta/insights/overview", params);
}
 ...
 */
export async function getMetaSocialInsights(params = {}) {
  return apiClient.get("/api/meta/insights/social", params);
}
 ...
 */
export async function getMetaContentInsights(params = {}) {
  return apiClient.get("/api/meta/insights/content", params);
}
 ...
 */
export async function getMetaAdsInsights(params = {}) {
  return apiClient.get("/api/meta/insights/ads", params);
}
 ...
 */
export async function getMetaCampaignInsights(params = {}) {
  return apiClient.get("/api/meta/insights/campaigns", params);
}
 ...
 */
export async function getMetaAdSetInsights(params = {}) {
  return apiClient.get("/api/meta/insights/adsets", params);
}
 ...
 * Params: { adAccountId, status, limit, after, since, until }
 */
export async function getMetaAdsLevelInsights(params = {}) {
  return apiClient.get("/api/meta/insights/ads-level", params);
}
